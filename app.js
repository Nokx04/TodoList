...
=======
import { filterTodosActive, filterTodosCompleted, filterTodosAll } from './filter.js';
...
document.getElementById('filterStatus').addEventListener('change', (event) => {
    ...
    switch (filterValue) {
        case 'toutes':
            filterTodosAll(taskList);
            break;
        case 'completé':
            filterTodosCompleted(taskList);
            break;
        case 'en_cours':
            filterTodosActive(taskList);
            break;
    }
});
>>>>>>> Stashed changes
